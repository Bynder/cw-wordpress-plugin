...
class Admin extends Base {
	...
	public function api_setup_settings_cb() {
		...
		if ( $key = $this->should_migrate() ) {
			echo '<p><strong>' .
			     esc_html__( 'NOTE:', 'content-workflow-by-bynder' ) .
			     '</strong> ' .
			     ...
			     sprintf( '<a href="%s" target="_blank">%s</a>', esc_url( 'https://gathercontent.com/developers/authentication/' ), esc_html__( 'here', 'content-workflow-by-bynder' ) ) .
			     '</p>';
			...
			echo '<p>' .
			     esc_html__( 'Enter your Content Workflow API credentials. Instructions for getting your API key can be found ', 'content-workflow-by-bynder' ) .
			     sprintf( '<a href="%s" target="_blank">%s</a>', esc_url( 'https://gathercontent.com/developers/authentication/' ), esc_html__( 'here', 'content-workflow-by-bynder' ) ) .
			     '</p>';
		}
	}
