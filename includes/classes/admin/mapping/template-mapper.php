...
class Template_Mapper extends Base {
	...
	public function ui_page() {
		...
		if ( $this->mapping_id ) {
			...
			<p class="description"><a href="' . esc_url( add_query_arg( 'sync-items', 1 ) ) . '"><span class="dashicons dashicons-randomize"> </span>' . esc_attr__( 'Import Items for this template from Content Workflow', 'content-workflow-by-bynder' ) . '</a></p>
			</div>';
