		...
		<div class="gc-bb-modal-content <# if ( data.navItems.length ) { #>has-nav-tabs<# } #>">
			...
			<div class="media-frame-router gc-bb-modal-nav-tabs">
				<div class="media-router">
					...
					<a class="media-menu-item <# if ( ! nav.hidden ) { #>active<# } #>" data-id="{{ nav.id }}" href="#">{{
						nav.label }}</a>
					<# }); #>
				</div>
			</div>
			...
			<div class="media-frame-toolbar">
				<div class="media-toolbar">
					<div class="media-toolbar-primary search-form">
						...
						<button id="gc-btn-{{ btn.id }}"
								class="button media-button button-<# if ( btn.primary ) { #>primary<# } else { #>secondary<# } #> button-large">
							{{ btn.label }}
						</button>
						<# }); } #>
					</div>
