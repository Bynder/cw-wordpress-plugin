...
<div class="misc-pub-section misc-gc-updated">
	<span class="dashicons dashicons-calendar"></span> <?php echo esc_html_x( 'Last Updated:', 'Content Workflow updated date', 'content-workflow-by-bynder' ); ?> <b><?php echo new self( 'underscore-data-updated', $this->args ); ?></b>
</div>
...
<div class="gc-major-publishing-actions">
	<div class="gc-publishing-action">
		...
		<button id="gc-disconnect" type="button" class="button gc-button-danger alignright" <# if ( ! data.mapping ) { #>disabled="disabled"<# } #>><?php esc_html_e( 'Disconnect', 'content-workflow-by-bynder' ); ?></button>
		<button id="gc-push" type="button" class="button gc-button-primary alignright" <# if ( ! data.mapping ) { #>disabled="disabled"<# } #>><?php esc_html_e( 'Push', 'content-workflow-by-bynder' ); ?></button>
		<button id="gc-pull" type="button" class="button gc-button-primary alignright" <# if ( ! data.mapping || ! data.item ) { #>disabled="disabled"<# } #>><?php esc_html_e( 'Pull', 'content-workflow-by-bynder' ); ?></button>
	</div>
	<div class="clear"></div>
</div>
<?php
