...
### End System Info ###</textarea>
		...
		<p><a href="https://gathercontent.com/support/wordpress-integration/" target="_blank"><?php esc_html_e( 'Support for Content Workflow WordPress Integration', 'content-workflow-by-bynder' ); ?></a></p>
		<p><a href="https://wordpress.org/support/plugin/gathercontent-import" target="_blank"><?php esc_html_e( 'WordPress Plugin Support Forums', 'content-workflow-by-bynder' ); ?></a></p>

		<p><?php esc_html_e( '<strong>This information contains potentially senstive data.</strong><br>Please be careful with where you post it. Do not post it in the WordPress support forums.', 'content-workflow-by-bynder' ); ?></p>
		<p class="submit">
