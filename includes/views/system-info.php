<div class="wrap gc-admin-wrap">
	...
	<form action="<?php echo esc_url( admin_url( 'admin.php?page=gathercontent-import-support' ) ); ?>" method="post"
		...
		<textarea readonly="readonly" onclick="this.focus();this.select()" id="system-info-textarea" name="gc-sysinfo"
				  title="<?php esc_attr_e( 'To copy the system info, click below then press Ctrl + C (PC) or Cmd + C (Mac).', 'content-workflow-by-bynder' ); ?>">
### Begin System Info ###
...
### End System Info ###</textarea>
		...
		<p>
			<strong>
				<?php esc_html_e( 'This information contains potentially senstive data.', 'content-workflow-by-bynder' ); ?>
			</strong>
			<br>
			<?php esc_html_e( 'Please be careful with where you post it. Do not post it in the WordPress support forums.', 'content-workflow-by-bynder' ); ?>
		</p>
		<p class="submit">
