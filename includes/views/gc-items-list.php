<a href="#" class="gc-reveal-items dashicons-before dashicons-arrow-right description <?php echo esc_attr($this->get( 'class')); ?>"><?php esc_attr_e( 'Sample of Items', 'content-workflow-by-bynder' ); ?> </a>
