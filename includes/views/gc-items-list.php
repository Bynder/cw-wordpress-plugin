<a href="#" class="gc-reveal-items dashicons-before dashicons-arrow-right description <?php $this->output( 'class', 'esc_attr' ); ?>"><?php esc_html_e( 'Sample of Items', 'content-workflow-by-bynder' ); ?> </a>
